...
- **db** - параметры для работы с LevelDB и настройки какие данные сохранять. Например, результаты некоторых тьора
- **network** - параметры передачи 
- **wallet**
- **blockchain**
- **miner**
- **rest-api**
