...
- размер одной транзакции записи данных в хранилище не более 140 килобайт
- размер данных на один ключ не более 32 килобайт
- размер ключа не более 100 символов

Ключами в хранилище могут быть только строки в формате UTF-8.
